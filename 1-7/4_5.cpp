...
int main()
{
    ...
    if(sizeof(int) == 4)
        cout << "Ten kompilator zapisuje wartosci typu int jako 4-bajtowe (4 * 8 = 32-bitowe)"
    << endl;
    else cout << "Uwaga: W tym kompilatorze typ int jest "
    "o rozmiarach innych niz 4 bajty" << endl;
}